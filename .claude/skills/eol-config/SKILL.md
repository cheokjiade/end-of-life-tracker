---
name: eol-config
description: Generate or update EOL tracker JSON configs from dependency manifests, Confluence or wiki inventories, spreadsheets, documents, or prose while preserving curated notes.
metadata:
